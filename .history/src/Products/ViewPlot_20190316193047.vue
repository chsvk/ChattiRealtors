        ...
        <div v-else class="details">
            <h1>{{plot.Name}}</h1>
                ...
                <div class="flex gallery">
                    <Hooper class="carousel" :settings="hooperSettings" v-if="!(DisplayImages[0]=='')">
                        <slide v-for="(image, index) in DisplayImages" :key="index" >
                            <img :src="image" alt="">
                        </slide>
                    </Hooper>
                    <Hooper class="carousel" :settings="hooperSettings" v-if="!(DevelopmentImages[0]=='')">
                        <slide v-for="(image, index) in DevelopmentImages" :key="index" >
                            <img :src="image" alt="">
                        </slide>
                    </Hooper>
                    <!-- <agile v-if="!(DisplayImages[0]=='') && imageReady" :autoplay="true" :arrows="false" :dots="false" :speed=1000>
                 ...
                 <siema
                        ref="siema"
                        :loop="true">
                        <div v-for="(image, index) in DevelopmentImages" :key="index">
                            <img :src="image" :alt="'Slide ' + n">
                        </div>
                    </siema>
            <div class="details">
