    ...
    <div class="plot">
        ...
        <div v-else class="details">
            ...
            <div class="flex">
                ...
                <h4 v-if="!(plot.DevelopmentImages[1]=='')">Development Images</h4>
                <agile v-if="!(plot.DevelopmentImages[1]=='')" :autoplay="true" :arrows="false" :dots="false" :speed=1000>
                    <div v-for="(image, index) in plot.DevelopmentImages[1]" :key="index" class="slide">
                        <img v-if="!(image==undefined)" :src="image">
                    </div>
                </agile>
            </div>
